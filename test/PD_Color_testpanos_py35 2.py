...
class SpeedyGonzalesPD:
    ...
    def compute_pd_control(self, left_value, right_value):
        ...
        # For line following: we want to stay on the WHITE-BLACK edge
        # Positive error = left sensor brighter than right (need to turn LEFT toward darker)
        # Negative error = right sensor brighter than left (need to turn RIGHT toward darker)
        ...
        # Apply correction to motors - CRITICAL LOGIC
        # When left sensor is brighter (positive error), robot is too far RIGHT of line
        # Need to turn LEFT: slow down right motor, speed up left motor
        # When right sensor is brighter (negative error), robot is too far LEFT of line
        # Need to turn RIGHT: slow down left motor, speed up right motor
