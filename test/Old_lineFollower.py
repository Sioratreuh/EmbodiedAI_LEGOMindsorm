...
KP = 18        # Proportional gain (unchanged) 18
KD = 3.5         # Derivative gain (unchanged) 3.5
BASE_SPEED = 25   # Nominal base forward speed 25
MAX_SPEED = 90    # Absolute maximum allowed speed per wheel 80 / 90
MIN_SPEED = 5     # Minimum allowed speed when near line (turning) 10 / 5
